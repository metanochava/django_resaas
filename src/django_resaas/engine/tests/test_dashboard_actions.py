...
no motor de dashboards - engine/core/dashboards/validator.py +
permissions.py.
"""
import pytest
...
from django_resaas.engine.core.dashboards.validator import DashboardValidator
...
class TestActionPermissionFiltering:
    ...
    def _isPermited_stub(self, monkeypatch, request):
        import django_resaas.engine.core.dashboards.permissions as perms_module
