...
def test_installed_apps_loaded():
    assert apps.is_installed("django_resaas.engine")
    ...
    # even though the importable path is "django_resaas.engine" (see
    # engine/apps.py's explicit `label = "django_resaas"` override).
