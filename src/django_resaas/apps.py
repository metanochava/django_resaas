...
class DjangoResaasConfig(AppConfig):
    ...
    def load_permissions(self):
        ...
        try:
            ...
            import django_resaas.core.signals.permissions  # noqa: F401
    ...
    def load_actions(self):
        ...
        try:
            ...
            import django_resaas.core.signals.action_sync  # noqa: F401
    ...
    def load_admin(self):
        ...
        try:
            ...
            from django_resaas.core.base.mixins.admin.auto import (
                register_all_models
            )
