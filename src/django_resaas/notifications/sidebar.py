...
SUBMENUS = [
    ...
    # create/update/partial_update/destroy devolvem sempre 405) - por
    # isso não têm add_role/add_route, tal como Payroll Run/Leave
    # Calendar em hr/sidebar.py seguem a mesma convenção para
    # workflows não-CRUD.
    {
        "icon": "outbox",
        "menu": "Outbox",
