key_value = {
    ...
    "Soft delete selected %(verbose_name_plural)s": "Eliminación suave de los %(verbose_name_plural)s seleccionados",
    "Deleted": "Eliminado",
    ...
    "Disable": "Desactivar",
    "Verify": "Verificar",
    "Save these recovery codes somewhere safe. Each one works once, and they will not be shown again.": "Guarde estos códigos de recuperación en un lugar seguro. Cada uno funciona una sola vez y no se volverán a mostrar.",
    "Set up two-factor authentication": "Configurar la autenticación de dos factores",
    "Could not start the setup.": "No se pudo iniciar la configuración.",
    "QR code": "Código QR",
    "Scan this QR code with an authenticator app, then enter the 6-digit code it shows.": "Escanee este código QR con una aplicación de autenticación e introduzca el código de 6 dígitos que muestra.",
    "Or enter this key manually": "O introduzca esta clave manualmente",
    "Open in authenticator app": "Abrir en la aplicación de autenticación",
    "Authentication code": "Código de autenticación",
    "Verify and enable": "Verificar y activar",
    "Two-factor authentication is now enabled.": "La autenticación de dos factores está ahora activada.",
    "I have saved my recovery codes": "He guardado mis códigos de recuperación",
    "Authentication code or recovery code": "Código de autenticación o código de recuperación",
    "Ask for a code from your authenticator app every time you sign in.": "Solicite un código de su aplicación de autenticación cada vez que inicie sesión.",
    "Could not load your two-factor settings.": "No se pudieron cargar sus ajustes de dos factores.",
    "Recovery codes left": "Códigos de recuperación restantes",
    "Your organisation requires two-factor authentication.": "Su organización exige autenticación de dos factores.",
    "Two-factor authentication is not available for your organisation.": "La autenticación de dos factores no está disponible para su organización.",
    ...
    "Enter a code to confirm. Your account will only be protected by its password.": "Introduzca un código para confirmar. Su cuenta solo quedará protegida por su contraseña.",
    "Enter a code to confirm. Your current recovery codes will stop working.": "Introduzca un código para confirmar. Sus códigos de recuperación actuales dejarán de funcionar.",
    "Your new recovery codes": "Sus nuevos códigos de recuperación",
    "Enter the 6-digit code from your authenticator app, or a recovery code.": "Introduzca el código de 6 dígitos de su aplicación de autenticación o un código de recuperación.",
    "Too many attempts. Try again in a few minutes.": "Demasiados intentos. Inténtelo de nuevo en unos minutos.",
    "Two-factor authentication is already active.": "La autenticación de dos factores ya está activa.",
    "There is no two-factor setup in progress.": "No hay ninguna configuración de dos factores en curso.",
    "Two-factor authentication is not active.": "La autenticación de dos factores no está activa.",
    "This sign-in step has expired. Sign in again.": "Este paso de inicio de sesión ha caducado. Inicie sesión de nuevo.",
    ...
    "New recovery codes generated": "Nuevos códigos de recuperación generados",
    "Two-factor authentication turned on": "Autenticación de dos factores activada",
    "Two-factor authentication turned off": "Autenticación de dos factores desactivada",
    "Recovery code used": "Código de recuperación utilizado",
    "Recovery codes regenerated": "Códigos de recuperación regenerados",
    "Inherit": "Heredar",
    "Two-factor policy": "Política de dos factores",
    "Two-factor authentication at this level. A REQUIRED level above can never be weakened by the levels below it.": "Autenticación de dos factores en este nivel. Un nivel superior OBLIGATORIO nunca puede ser debilitado por los niveles inferiores.",
    "Create Person": "Crear persona",
    "New person": "Nueva persona",
    "Preview PDF": "Vista previa del PDF",
    "Please correct the highlighted fields.": "Corrija los campos resaltados.",
    "An unexpected error occurred. Please try again later.": "Se produjo un error inesperado. Inténtelo de nuevo más tarde.",
    "Authentication credentials were not provided.": "No se proporcionaron las credenciales de autenticación.",
    "You do not have permission to perform this action.": "No tiene permiso para realizar esta acción.",
    "Not found.": "No encontrado.",
    "The request conflicts with the current state of the resource.": "La solicitud entra en conflicto con el estado actual del recurso.",
    ...
    "Import permissions (CSV)": "Importar permisos (CSV)",
    "Download permissions (CSV)": "Descargar permisos (CSV)",
    "Download permissions (PDF)": "Descargar permisos (PDF)",
    "Use a CSV with a codename column (and app when a codename exists in several apps). A file downloaded here can be edited and imported back.": "Use un CSV con la columna codename (y app cuando un codename existe en varias apps). Un archivo descargado aquí puede editarse e importarse de nuevo.",
    "CSV file": "Archivo CSV",
    "Add to the current permissions": "Añadir a los permisos actuales",
    "Replace the permissions with the file": "Reemplazar los permisos por los del archivo",
    "Nothing was changed. Rows in error:": "No se cambió nada. Filas con error:",
    "Line": "Línea",
    "Permissions imported": "Permisos importados",
    "Choose a CSV file.": "Elija un archivo CSV.",
    "The file is too large (maximum 1 MB).": "El archivo es demasiado grande (máximo 1 MB).",
    "The file must be UTF-8 CSV.": "El archivo debe ser CSV en UTF-8.",
    "The file needs a 'codename' column.": "El archivo necesita una columna 'codename'.",
    "Too many rows (maximum 5000).": "Demasiadas filas (máximo 5000).",
    "Some rows are not valid. Nothing was changed.": "Algunas filas no son válidas. No se cambió nada.",
    "Invalid import mode.": "Modo de importación no válido.",
    "Codename": "Codename",
    "Download JSON": "Descargar JSON",
    "Import JSON": "Importar JSON",
    "JSON file": "Archivo JSON",
    "Import profiles (JSON)": "Importar perfiles (JSON)",
    "Download profiles (JSON)": "Descargar perfiles (JSON)",
    "Download profiles (PDF)": "Descargar perfiles (PDF)",
    "A JSON with this entity type's profiles and their permissions. New profiles are created; profiles not in the file are not changed. A file downloaded here can be edited and imported back.": 'Un JSON con los perfiles de este tipo de entidad y sus permisos. Los perfiles nuevos se crean; los que no están en el archivo no se modifican. Un archivo descargado aquí puede editarse e importarse de nuevo.',
    "Nothing was changed. Errors:": "No se cambió nada. Errores:",
    "Choose a JSON file.": "Elija un archivo JSON.",
    "The file is too large (maximum 2 MB).": "El archivo es demasiado grande (máximo 2 MB).",
    "The file must be UTF-8 JSON.": "El archivo debe ser JSON en UTF-8.",
    "The file is not valid JSON.": "El archivo no es un JSON válido.",
    "The file needs a 'profiles' list.": "El archivo necesita una lista 'profiles'.",
    "Too many profiles (maximum 200).": "Demasiados perfiles (máximo 200).",
    "Each profile needs a name (up to 150 characters).": "Cada perfil necesita un nombre (hasta 150 caracteres).",
    "This profile appears more than once.": "Este perfil aparece más de una vez.",
