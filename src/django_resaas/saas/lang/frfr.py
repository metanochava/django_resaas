key_value = {
    ...
    "Disable": "Désactiver",
    "Verify": "Vérifier",
    "Save these recovery codes somewhere safe. Each one works once, and they will not be shown again.": "Conservez ces codes de récupération en lieu sûr. Chacun ne fonctionne qu'une fois et ils ne seront plus affichés.",
    ...
    "QR code": "Code QR",
    "Scan this QR code with an authenticator app, then enter the 6-digit code it shows.": "Scannez ce code QR avec une application d'authentification, puis saisissez le code à 6 chiffres affiché.",
    "Or enter this key manually": "Ou saisissez cette clé manuellement",
    "Open in authenticator app": "Ouvrir dans l'application d'authentification",
    "Authentication code": "Code d'authentification",
    "Verify and enable": "Vérifier et activer",
    "Two-factor authentication is now enabled.": "L'authentification à deux facteurs est maintenant activée.",
    "I have saved my recovery codes": "J'ai enregistré mes codes de récupération",
    "Authentication code or recovery code": "Code d'authentification ou code de récupération",
    "Ask for a code from your authenticator app every time you sign in.": "Demandez un code de votre application d'authentification à chaque connexion.",
    "Could not load your two-factor settings.": "Impossible de charger vos paramètres à deux facteurs.",
    "Recovery codes left": "Codes de récupération restants",
    "Your organisation requires two-factor authentication.": "Votre organisation exige l'authentification à deux facteurs.",
    "Two-factor authentication is not available for your organisation.": "L'authentification à deux facteurs n'est pas disponible pour votre organisation.",
    "New recovery codes": "Nouveaux codes de récupération",
    "Disable two-factor authentication": "Désactiver l'authentification à deux facteurs",
    "Enter a code to confirm. Your account will only be protected by its password.": "Saisissez un code pour confirmer. Votre compte ne sera protégé que par son mot de passe.",
    "Enter a code to confirm. Your current recovery codes will stop working.": "Saisissez un code pour confirmer. Vos codes de récupération actuels cesseront de fonctionner.",
    "Your new recovery codes": "Vos nouveaux codes de récupération",
    "Enter the 6-digit code from your authenticator app, or a recovery code.": "Saisissez le code à 6 chiffres de votre application d'authentification ou un code de récupération.",
    "Too many attempts. Try again in a few minutes.": "Trop de tentatives. Réessayez dans quelques minutes.",
    "Two-factor authentication is already active.": "L'authentification à deux facteurs est déjà active.",
    "There is no two-factor setup in progress.": "Aucune configuration à deux facteurs n'est en cours.",
    "Two-factor authentication is not active.": "L'authentification à deux facteurs n'est pas active.",
    "This sign-in step has expired. Sign in again.": "Cette étape de connexion a expiré. Reconnectez-vous.",
    ...
    "Two-factor authentication turned on": "Authentification à deux facteurs activée",
    "Two-factor authentication turned off": "Authentification à deux facteurs désactivée",
    ...
    "Not found.": "Introuvable.",
    "The request conflicts with the current state of the resource.": "La requête est en conflit avec l'état actuel de la ressource.",
    "The request could not be completed.": "La requête n'a pas pu être traitée.",
    ...
    "This profile is shared with other entities and can only be changed at platform level.": "Ce profil est partagé avec d’autres entités et ne peut être modifié qu’au niveau de la plateforme.",
    "You cannot grant or revoke permissions you do not have.": "Vous ne pouvez pas accorder ni retirer des autorisations que vous n’avez pas.",
    "This profile is not editable and can only be changed at platform level.": "Ce profil n’est pas modifiable et ne peut être modifié qu’au niveau de la plateforme.",
    "A permission with this codename already exists.": "Une autorisation avec ce codename existe déjà.",
    "You cannot delete the profile you are currently using.": "Vous ne pouvez pas supprimer le profil que vous utilisez.",
    'This profile is not available for this entity type.': 'Ce profil n’est pas disponible pour ce type d’entité.',
    'Download CSV': 'Télécharger le CSV',
    'Import CSV': 'Importer un CSV',
    'Import permissions (CSV)': 'Importer des autorisations (CSV)',
    'Download permissions (CSV)': 'Télécharger les autorisations (CSV)',
    'Download permissions (PDF)': 'Télécharger les autorisations (PDF)',
    'Use a CSV with a codename column (and app when a codename exists in several apps). A file downloaded here can be edited and imported back.': 'Utilisez un CSV avec une colonne codename (et app quand un codename existe dans plusieurs apps). Un fichier téléchargé ici peut être modifié puis réimporté.',
    'CSV file': 'Fichier CSV',
    'Add to the current permissions': 'Ajouter aux autorisations actuelles',
    'Replace the permissions with the file': 'Remplacer les autorisations par celles du fichier',
    'Nothing was changed. Rows in error:': 'Rien n’a été modifié. Lignes en erreur :',
    'Line': 'Ligne',
    'Permissions imported': 'Autorisations importées',
    'Choose a CSV file.': 'Choisissez un fichier CSV.',
    'The file is too large (maximum 1 MB).': 'Le fichier est trop volumineux (maximum 1 Mo).',
    'The file must be UTF-8 CSV.': 'Le fichier doit être un CSV en UTF-8.',
    "The file needs a 'codename' column.": 'Le fichier doit avoir une colonne « codename ».',
    'Too many rows (maximum 5000).': 'Trop de lignes (maximum 5000).',
    'Some rows are not valid. Nothing was changed.': 'Certaines lignes ne sont pas valides. Rien n’a été modifié.',
    'Invalid import mode.': 'Mode d’importation non valide.',
    'Codename': 'Codename',
    'Download JSON': 'Télécharger le JSON',
    'Import JSON': 'Importer un JSON',
    'JSON file': 'Fichier JSON',
    'Import profiles (JSON)': 'Importer des profils (JSON)',
    'Download profiles (JSON)': 'Télécharger les profils (JSON)',
    'Download profiles (PDF)': 'Télécharger les profils (PDF)',
    "A JSON with this entity type's profiles and their permissions. New profiles are created; profiles not in the file are not changed. A file downloaded here can be edited and imported back.": 'Un JSON avec les profils de ce type d’entité et leurs autorisations. Les nouveaux profils sont créés ; ceux absents du fichier ne sont pas modifiés. Un fichier téléchargé ici peut être modifié puis réimporté.',
    'Nothing was changed. Errors:': 'Rien n’a été modifié. Erreurs :',
    'Choose a JSON file.': 'Choisissez un fichier JSON.',
    'The file is too large (maximum 2 MB).': 'Le fichier est trop volumineux (maximum 2 Mo).',
    'The file must be UTF-8 JSON.': 'Le fichier doit être un JSON en UTF-8.',
    'The file is not valid JSON.': 'Le fichier n’est pas un JSON valide.',
    "The file needs a 'profiles' list.": 'Le fichier doit avoir une liste « profiles ».',
    'Too many profiles (maximum 200).': 'Trop de profils (maximum 200).',
    'Each profile needs a name (up to 150 characters).': 'Chaque profil doit avoir un nom (jusqu’à 150 caractères).',
    'This profile appears more than once.': 'Ce profil apparaît plusieurs fois.',
