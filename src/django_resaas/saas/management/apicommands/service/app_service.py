...
from django_resaas.saas.core.utils import clean_name, clean_class_name, clean_file_name
...
class AppScaffoldService:
    ...
    def create_back(cls, name: str):
        ...
        if name == 'django_resaas' or name == 'hr' or name == 'notifications':
            raise CommandError(f"Module '{name}' already exists")
