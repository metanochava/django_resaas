...
from django_resaas.saas.core.doctor import checks  # noqa: F401  (populates CHECK_REGISTRY)
from django_resaas.saas.core.doctor.base import CHECK_REGISTRY, CheckResult
