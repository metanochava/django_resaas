...
saas/core/base/permissions.py) e a verificação de módulo activo já
existente (is_module_active, saas/core/base/dashboard.py, extraída
...
from django_resaas.saas.core.dashboards.exceptions import DashboardPermissionError
