...
Uso:
    ...
    from django_resaas.saas.core.dashboards.providers import register_provider, BaseDashboardProvider
...
from django_resaas.saas.core.base.dashboard import apply_tenant_scope
