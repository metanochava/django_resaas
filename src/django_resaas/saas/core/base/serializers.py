...
from .mixins.serializer.field_permissions import FieldPermissionsMixin
...
from .mixins.serializer.tenant_relations import TenantRelationsMixin


class BaseSerializer(
    FieldPermissionsMixin,
    TenantRelationsMixin,
    DynamicFieldsMixin,
