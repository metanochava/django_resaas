...
class Entidade(TimeModel):
    ...
    layout_settings = models.ForeignKey('LayoutSetting', null=True, blank=True, on_delete=models.SET_NULL)
    typography = models.ForeignKey('Typography', null=True, blank=True, on_delete=models.SET_NULL)
    animation_settings = models.ForeignKey('AnimationSetting', null=True, blank=True, on_delete=models.SET_NULL)
